...
model = load_model('D:/KMITL/Work/Year3/Term1/AI/WebApp/ai/project/src/models/EfficientNetB7_model.keras')  # Path to your saved model

# Define the path to the base directory
BASE_DIR = 'D:/KMITL/Work/Year3/Term1/AI/WebApp/ai/project/src/models'
